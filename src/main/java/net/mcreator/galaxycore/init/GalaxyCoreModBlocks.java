...
import net.mcreator.galaxycore.block.GalaxyOreBlock;
...
public class GalaxyCoreModBlocks {
	...
	public static final RegistryObject<Block> GALAXY_ORE = REGISTRY.register("galaxy_ore", () -> new GalaxyOreBlock());
